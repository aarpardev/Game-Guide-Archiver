...
module.exports = {
    getHome: async(req, res) => {
        ...
        .then( (menuData) => {
          res.render('index', {title:'Game Guides App', data:menuData, search:'', loggedIn:sesh.loggedIn});
        });
    },
    getSearch: async(req, res) => {
        ...
        res.render('index', {title:'Game Guides App', data:menuData, search:q, loggedIn:sesh.loggedIn});
      }
}